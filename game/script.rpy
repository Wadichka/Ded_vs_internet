...
label cont7:
   ...
   scene cg sobes_everygod with dissolve
   ...
   nmike "Ага."
   nded "Мы решаем не мешать этому человеку и подождать. {w}Однако, проходит 15 минут, полчаса, час…"
   nded "И лишь только спустя 2 часа, человек заканчивает разговор и записывает видео, где говорит:"
   nded "“...Друзья, привет. Мне недавно захотелось скачать мессенджер DedMAXim, и знаете, что?"
   nded "Я просто в ахуе от того, что это приложение работает даже [place]."
   nded "Мы 2 часа проболтали без остановки, и связь ни разу не прервалась."
   nded "Обязательно общайтесь с близкими по приложению DedMAXim без каких-либо ограничений по времени и с идеальным качеством связи!”"
   ...
   ya3 "Очень вэри неплохо (bad), Макакий, у меня с ними ну это… {w}типо очень горячие (metrosexual) отношения, и всё доходит до биг степиков биг рексиков."
   ded "Поделись опытом."
   ...
   nazazin "Но когда я пришёл, она захлопнула и заперла дверь, после чего сказала:"
   ...
   nded "Каждый раз, когда [waifu] просит освободить её, [unfavmaker] лишь говорит, почему это невозможно, а в конце добавляет: “Ладно, не будем об этом. Держи по бутерброду”."
   nded "ГГ, погоревав и выпив стакана лимонада “[favlem]”, отправляется в путь за своей любовью."
   nded "Он проходит воду, огонь, медные трубы. Проходит Чеховский лес, Левенцовку, Суховку, Сыктывкар и Заводской район в Саратове без единой царапины."
